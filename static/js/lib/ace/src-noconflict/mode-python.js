...
var PythonHighlightRules = function() {
    ...
    var keywords = (
        ...
        "raise|return|try|while|with|yield|async|await|nonlocal|Axiom|" +
	    "|module|derivation|length|production|interpretation|endlsystem|" +
        "pattern|produce|nproduce|homomorphism|maximum|depth|decomposition|" +
        "group|endgroup|ignore|consider" 
    );
